...
class Register extends React.Component {
    ...
    handleLoad = (event) => {
      ...
      firebase.database().ref('Labourer').child(search_phone_number).once('value', (snapshot) => {
        if(snapshot.exists()) {
          this.setState({
    ...
    handleSubmit = (event) => {
      ...
      if(Phone_number==null|| First_name==null||Last_name==null||Address==null){
        ...
        if(search_phone_number !== Phone_number) {
          firebase.database().ref("Labourer").child(search_phone_number).remove();
        }
    ...
    render() {
      ...
      return (
        ...
        <h2 className="heading">Update Labourer</h2>
